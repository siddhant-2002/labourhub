      ...
      <nav className="bg-white shadow-sm fixed w-full z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            ...
            <Link to="/" className="text-2xl font-bold text-blue-600">LabourHub</Link>            </div>
            ...
            <Link to="/" className="text-gray-700 hover:text-blue-600">Home</Link>
              ...
              <button onClick={() => navigate('/login')} className="bg-blue-600 text-white px-6 py-2 rounded-full hover:bg-blue-700 transition-colors">
                Login
              </button>
            </div>
        ...
        {isOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              ...
              <button onClick={() => navigate('/login')} className="w-full text-center bg-primary-700 text-white px-6 py-2 rounded-full hover:bg-blue-700 transition-colors">
                Login
              </button>
            </div>
          </div>
